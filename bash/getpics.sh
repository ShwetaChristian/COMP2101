...
#     then delete the local copy of the tarfile if the extraction was successful
([ -f  ~/public_html/pics/pics.tgz ] || wget -nv -O ~/public_html/pics/pics.tgz http://zonzorp.net/pics.tgz) && tar -xf ~/public_html/pics/pics.tgz -C ~/public_html/pics && rm ~/public_html/pics/pics.tgz
